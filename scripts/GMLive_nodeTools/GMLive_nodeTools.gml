...
if(live_enabled)
function gml_node_tools_is_simple(l_q){
	var l_i,l_n,l_w;
	var l__g=l_q;
	switch(l__g.__enumIndex__){
		...
		case 4:
			...
			l_i=0;
			while(l_i<l_n){
				if(gml_node_tools_is_simple(l_w[l_i]))l_i++; else break;
			}
			return l_i>=l_n;
		case 5:
			l_w=l__g.h_values;
		...
		case 8:return true;
		case 9:return true;
		case 41:return gml_node_tools_is_simple(l__g.h_x);
		case 56:return gml_node_tools_is_simple(l__g.h_x)&&gml_node_tools_is_simple(l__g.h_id);
...
function gml_node_tools_equals(l_a,l_b){
	...
	switch(l__g.__enumIndex__){
		...
		case 32:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==32)return gml_node_tools_equals(l__g.h_v,l__g1.h_v); else return false;
		case 33:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==33)return gml_node_tools_equals(l__g.h_v,l__g1.h_v); else return false;
		case 34:
			var l__g1=l_b;
		...
		case 6:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==6)return gml_node_tools_equals(l__g.h_expr,l__g1.h_expr); else return false;
		case 18:
			var l__g1=l_b;
		...
		case 15:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==15)return gml_node_tools_equals(l__g.h_id,l__g1.h_id); else return false;
		case 86:
			var l__g1=l_b;
		...
		case 92:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==92)return gml_node_tools_equals_list(l__g.h_nodes,l__g1.h_nodes); else return false;
		case 93:
		...
		case 96:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==96)return gml_node_tools_equals(l__g.h_time,l__g1.h_time); else return false;
		case 45:
			var l__g1=l_b;
		...
		case 104:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==104)return gml_node_tools_equals(l__g.h_node,l__g1.h_node); else return false;
		case 105:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==105)return gml_node_tools_equals(l__g.h_v,l__g1.h_v); else return false;
		case 44:
			var l__g1=l_b;
		...
		case 111:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==111)return gml_node_tools_equals(l__g.h_x,l__g1.h_x); else return false;
		case 41:
			var l__g1=l_b;
		...
		case 4:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==4)return gml_node_tools_equals_list(l__g.h_values,l__g1.h_values); else return false;
		case 12:
			var l__g1=l_b;
...
function gml_node_tools_clone(l_q){
	...
	switch(l__g.__enumIndex__){
		...
		case 6:return gml_node_ensure_array(l_d,gml_node_tools_clone(l__g.h_expr));
		...
		case 15:return gml_node_arg_index(l_d,gml_node_tools_clone(l__g.h_id));
		...
		case 21:return gml_node_call_script_with_array(l_d,gml_node_tools_clone(l__g.h_index),gml_node_tools_clone(l__g.h_array));
		case 22:
			l_xw=gml_std_gml_internal_ArrayImpl_copy(l__g.h_args);
			l_fi=array_length(l_xw);
			while(--l_fi>=0){
		...
		case 27:return gml_node_prefix(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_inc);
		case 28:return gml_node_postfix(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_inc);
		case 29:return gml_node_un_op(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_o);
		case 30:return gml_node_bin_op(l_d,l__g.h_o,gml_node_tools_clone(l__g.h_a),gml_node_tools_clone(l__g.h_b));
		case 94:return gml_node_ternary(l_d,gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_then),gml_node_tools_clone(l__g.h_not));
		case 32:return gml_node_to_bool(l_d,gml_node_tools_clone(l__g.h_v));
		case 33:return gml_node_from_bool(l_d,gml_node_tools_clone(l__g.h_v));
		case 34:return gml_node_in(l_d,gml_node_tools_clone(l__g.h_fd),gml_node_tools_clone(l__g.h_val),l__g.h_not);
		case 35:return gml_node_local(l_d,l__g.h_id);
		case 36:return gml_node_local_set(l_d,l__g.h_id,gml_node_tools_clone(l__g.h_val));
		case 37:return gml_node_local_aop(l_d,l__g.h_id,l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 38:return gml_node_global(l_d,l__g.h_id);
		case 39:return gml_node_global_set(l_d,l__g.h_id,gml_node_tools_clone(l__g.h_val));
		case 41:return gml_node_field(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd);
		case 42:return gml_node_field_set(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd,gml_node_tools_clone(l__g.h_val));
		case 43:return gml_node_field_aop(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd,l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 44:return gml_node_env(l_d,l__g.h_id);
		case 45:return gml_node_env_set(l_d,l__g.h_id,gml_node_tools_clone(l__g.h_val));
		case 46:return gml_node_env_aop(l_d,l__g.h_id,l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 47:return gml_node_env_fd(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd);
		case 48:return gml_node_env_fd_set(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd,gml_node_tools_clone(l__g.h_v));
		case 49:return gml_node_env_fd_aop(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd,l__g.h_op,gml_node_tools_clone(l__g.h_v));
		case 50:return gml_node_env1d(l_d,l__g.h_id,gml_node_tools_clone(l__g.h_k));
		case 51:return gml_node_env1d_set(l_d,l__g.h_id,gml_node_tools_clone(l__g.h_k),gml_node_tools_clone(l__g.h_val));
		case 52:return gml_node_env1d_aop(l_d,l__g.h_id,gml_node_tools_clone(l__g.h_k),l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 53:return gml_node_alarm(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i));
		case 54:return gml_node_alarm_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),gml_node_tools_clone(l__g.h_v));
		case 55:return gml_node_alarm_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_op,gml_node_tools_clone(l__g.h_v));
		case 56:return gml_node_index(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id));
		case 57:return gml_node_index_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 58:return gml_node_index_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 59:return gml_node_index_prefix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_inc);
		case 60:return gml_node_index_postfix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_inc);
		case 61:return gml_node_index2d(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2));
		case 62:return gml_node_index2d_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),gml_node_tools_clone(l__g.h_v));
		case 63:return gml_node_index2d_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 64:return gml_node_index2d_prefix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),gml_node_tools_clone(l__g.h_k),l__g.h_inc);
		case 65:return gml_node_index2d_postfix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),gml_node_tools_clone(l__g.h_k),l__g.h_inc);
		case 66:return gml_node_raw_id(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id));
		case 67:return gml_node_raw_id_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 68:return gml_node_raw_id_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 69:return gml_node_raw_id_prefix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_inc);
		case 70:return gml_node_raw_id_postfix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_inc);
		case 71:return gml_node_raw_id2d(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2));
		case 72:return gml_node_raw_id2d_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),gml_node_tools_clone(l__g.h_v));
		case 73:return gml_node_raw_id2d_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 74:return gml_node_raw_id2d_prefix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),gml_node_tools_clone(l__g.h_k),l__g.h_inc);
		case 75:return gml_node_raw_id2d_postfix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),gml_node_tools_clone(l__g.h_k),l__g.h_inc);
		case 76:return gml_node_ds_list(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id));
		case 77:return gml_node_ds_list_set(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 78:return gml_node_ds_list_aop(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 79:return gml_node_ds_list_prefix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_inc);
		case 80:return gml_node_ds_list_postfix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_inc);
		case 81:return gml_node_ds_map(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id));
		case 82:return gml_node_ds_map_set(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 83:return gml_node_ds_map_aop(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 84:return gml_node_ds_map_prefix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_inc);
		case 85:return gml_node_ds_map_postfix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_inc);
		case 86:return gml_node_ds_grid(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2));
		case 87:return gml_node_ds_grid_set(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),gml_node_tools_clone(l__g.h_v));
		case 88:return gml_node_ds_grid_aop(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 89:return gml_node_ds_grid_prefix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),gml_node_tools_clone(l__g.h_k),l__g.h_inc);
		case 90:return gml_node_ds_grid_postfix(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),gml_node_tools_clone(l__g.h_k),l__g.h_inc);
		case 91:return gml_node_var_decl(l_d,l__g.h_name,gml_node_tools_clone_opt(l__g.h_value));
		case 92:
		...
		case 93:return gml_node_if_then(l_d,gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_then),gml_node_tools_clone_opt(l__g.h_not));
		case 118:return gml_node_comment_block_post(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_s,l__g.h_pl);
		case 31:return gml_node_set_op(l_d,l__g.h_o,gml_node_tools_clone(l__g.h_a),gml_node_tools_clone(l__g.h_b));
		case 96:return gml_node_wait(l_d,gml_node_tools_clone(l__g.h_time));
		case 97:return gml_node_fork(l_d);
		case 98:return gml_node_while(l_d,gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_node));
		case 99:return gml_node_do_until(l_d,gml_node_tools_clone(l__g.h_node),gml_node_tools_clone(l__g.h_cond));
		case 100:return gml_node_do_while(l_d,gml_node_tools_clone(l__g.h_node),gml_node_tools_clone(l__g.h_cond));
		case 101:return gml_node_repeat(l_d,gml_node_tools_clone(l__g.h_times),gml_node_tools_clone(l__g.h_node));
		case 102:return gml_node_for(l_d,gml_node_tools_clone(l__g.h_pre),gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_post),gml_node_tools_clone(l__g.h_loop));
		case 103:return gml_node_with(l_d,gml_node_tools_clone(l__g.h_ctx),gml_node_tools_clone(l__g.h_node));
		case 104:return gml_node_once(l_d,gml_node_tools_clone(l__g.h_node));
		case 105:return gml_node_return(l_d,gml_node_tools_clone(l__g.h_v));
		...
		case 110:return gml_node_try_catch(l_d,gml_node_tools_clone(l__g.h_node),l__g.h_cap,gml_node_tools_clone(l__g.h_cat));
		case 111:return gml_node_throw(l_d,gml_node_tools_clone(l__g.h_x));
		case 112:return gml_node_comment_line(l_d,l__g.h_s);
		case 113:return gml_node_comment_line_pre(l_d,l__g.h_s,gml_node_tools_clone(l__g.h_x));
		case 114:return gml_node_comment_line_post(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_s);
		case 115:return gml_node_comment_line_sep(l_d,l__g.h_s,gml_node_tools_clone(l__g.h_x));
		case 116:return gml_node_comment_block(l_d,l__g.h_s);
		case 117:return gml_node_comment_block_pre(l_d,l__g.h_s,gml_node_tools_clone(l__g.h_x),l__g.h_pl);
		case 40:return gml_node_global_aop(l_d,l__g.h_id,l__g.h_op,gml_node_tools_clone(l__g.h_val));
